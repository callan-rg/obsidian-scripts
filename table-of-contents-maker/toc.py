...
def main():
    ...
    with open(output_file, 'w') as file_out:
        # Write a header or title for the index file
        ...
        for fname in sorted_files:
            ...
            title = fname[4:-3] # Assuming the title starts at the 4th char and ends before ".md"

            # Make the markdown link
            markdown_link = f"1. [[{fname}|{title}]]\n"

            # Write the markdown link to the output file
            file_out.write(markdown_link)

    print(f"Index file '{output_file}' has been created with links to markdown files.")
